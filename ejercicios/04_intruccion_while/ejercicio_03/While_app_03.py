...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.btn_pedir_clave.grid(row=4, pady=40, columnspan=4, sticky="nsew")
        
    
    def btn_pedir_clave_on_click(self):
        
        clave = prompt("Cuenta","Ingrese la contraseña")
        while (clave != 'utn750'):
         clave = prompt("Incorrecto","Vuelva a ingresar la contraseña")
